        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    ...
                    `In order to join TGS, you need a 64-bit installation of Java ${javaVer}. Would you like us to install a copy?`,
                    'Install Java',
                    'Install Manually'
                )
                setOverlayHandler(() => {
            ...
            if(login && allGood) {
                ...
                const gameStateChange = function(data){
                    ...
                    if(SERVER_JOINED_REGEX.test(data)){
                        DiscordWrapper.updateDetails('Hopping Dimensions!')
                    } else if(GAME_JOINED_REGEX.test(data)){
                        DiscordWrapper.updateDetails('Mining for Diamonds!')
                    }
                }
